...
def load_gemeinden2d(selectedcantons):
    ...
    ctdict = {1.0: 'ZH', 2.0: 'BE', 3.0: 'LU', 4.0: 'UR', 5.0: 'SZ', 6.0: 'OW', 7.0: 'NW', 8.0: 'GL', 9.0: 'ZG', 10.0: 'FR', 11.0: 'SO', 12.0: 'BS', 13.0: 'BL', 14.0: 'SH', 15.0: 'AR', 16.0: 'AI', 17.0: 'SG', 19.0: 'AG', 20.0: 'TG', 22.0: 'VD', 23.0: 'VS', 24.0: 'NE', 25.0: 'GE', 26.0: 'JU'}
